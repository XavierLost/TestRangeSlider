...
open class CircularSlider: UIControl {
     ...
     */
    @IBInspectable
    @objc open var diskFillColor: UIColor = .clear
     ...
     */
    @IBInspectable
    @objc open var diskColor: UIColor = .gray
     ...
     */
    @IBInspectable
    @objc open var trackFillColor: UIColor = .clear
     ...
     */
    @IBInspectable
    @objc open var trackColor: UIColor = .white
     ...
     */
    @IBInspectable
    @objc open var lineWidth: CGFloat = 5.0
     ...
     */
    @IBInspectable
    @objc open var backtrackLineWidth: CGFloat = 5.0
     ...
     */
    @IBInspectable
    @objc open var trackShadowOffset: CGPoint = .zero
     ...
     */
    @IBInspectable
    @objc open var trackShadowColor: UIColor = .gray
     ...
     */
    @IBInspectable
    @objc open var thumbLineWidth: CGFloat = 4.0
     ...
     */
    @IBInspectable
    @objc open var thumbRadius: CGFloat = 13.0
     ...
     */
    @IBInspectable
    @objc open var endThumbTintColor: UIColor = .groupTableViewBackground
     ...
     */
    @IBInspectable
    @objc open var endThumbStrokeHighlightedColor: UIColor = .blue
     ...
     */
    @IBInspectable
    @objc open var endThumbStrokeColor: UIColor = .red
     ...
     */
    @IBInspectable
    @objc open var numberOfRounds: Int = 1 {
        didSet {
     ...
     */
    @IBInspectable
    @objc open var minimumValue: CGFloat = 0.0 {
        didSet {
     ...
     */
    @IBInspectable
    @objc open var maximumValue: CGFloat = 1.0 {
        didSet {
     ...
     */
    @objc internal var radius: CGFloat {
        get {
