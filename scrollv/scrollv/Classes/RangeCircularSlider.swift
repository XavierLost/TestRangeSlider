...
open class RangeCircularSlider: CircularSlider {
     ...
     */
    @IBInspectable
    @objc open var startThumbTintColor: UIColor = UIColor.groupTableViewBackground
     ...
     */
    @IBInspectable
    @objc open var startThumbStrokeColor: UIColor = UIColor.green
     ...
     */
    @IBInspectable
    @objc open var startThumbStrokeHighlightedColor: UIColor = UIColor.purple
     ...
     */
    @objc override open var minimumValue: CGFloat {
        didSet {
     ...
     */
    @IBInspectable
    @objc override open var maximumValue: CGFloat {
        didSet {
    ...
    */
    @IBInspectable
    @objc open var distance: CGFloat = -1 {
        didSet {
